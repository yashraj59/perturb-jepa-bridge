...
- `regularized_cca`: pass=True, collapse=False, recall@1=0.2812, rna_min_std=0.7133, image_min_std=0.7535, rna_R2=0.7846, image_R2=0.9097, batch_bal_acc=0.5938
- `pls_cross_covariance`: pass=True, collapse=False, recall@1=0.2812, rna_min_std=6.2555, image_min_std=10.3732, rna_R2=0.7349, image_R2=0.9687, batch_bal_acc=0.5938
- `ridge_rna_to_image_pca`: pass=True, collapse=False, recall@1=0.2812, rna_min_std=1.0028, image_min_std=0.9743, rna_R2=0.6457, image_R2=0.9693, batch_bal_acc=0.5938
