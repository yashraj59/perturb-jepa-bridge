...
- `ridge_rna_to_image_pca`: pass=False, collapse=False, recall@1=0.3125, rna_min_std=0.8861, image_min_std=0.9863, rna_R2=0.4773, image_R2=0.9174, batch_bal_acc=0.8125
- `regularized_cca`: pass=False, collapse=False, recall@1=0.2812, rna_min_std=0.8806, image_min_std=0.9167, rna_R2=0.6095, image_R2=0.9022, batch_bal_acc=0.6875
- `pls_cross_covariance`: pass=False, collapse=False, recall@1=0.2500, rna_min_std=7.0888, image_min_std=14.0351, rna_R2=0.5724, image_R2=0.9190, batch_bal_acc=0.6562
