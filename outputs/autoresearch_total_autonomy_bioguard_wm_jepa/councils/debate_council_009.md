...
| --- | ---: | ---: | --- |
| C003 train-only delta support audit | 0.886 | 0.700 | Run C003_TRAIN_ONLY_DELTA_SUPPORT_AUDIT. |
| E3 graph/program action descriptors | 0.771 | 0.650 | Defer until train-only delta support predicts held-out floor failures. |
| D1 prototype transport | 0.757 | 0.650 | Defer until delta support audit clarifies whether prototypes can help. |

## Monitor Decision
`COUNCIL_EXECUTE`

## Exact Next Amendment
Execute `C003 train-only delta support audit`.

## Next Experiment Command Or Target
`Run C003_TRAIN_ONLY_DELTA_SUPPORT_AUDIT.`
