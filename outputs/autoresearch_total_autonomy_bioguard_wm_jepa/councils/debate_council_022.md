...
| --- | ---: | ---: | --- |
| C004 cell-line/source-dominance representation audit | 0.906 | 0.780 | Run C004_CELL_LINE_SOURCE_DOMINANCE_AUDIT. |
| C005 perturbation-centered retrieval target repair | 0.784 | 0.640 | Defer until source/cell-line dominance is quantified. |
| G001 fresh synthetic seed latent-cache audit | 0.810 | 0.650 | Defer until representation dominance is confirmed or falsified. |

## Monitor Decision
`COUNCIL_EXECUTE`

## Exact Next Amendment
Execute `C004 cell-line/source-dominance representation audit`.

## Next Experiment Command Or Target
`Run C004_CELL_LINE_SOURCE_DOMINANCE_AUDIT.`
