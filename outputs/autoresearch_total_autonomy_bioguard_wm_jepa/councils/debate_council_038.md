...
| --- | ---: | ---: | --- |
| F012 benchmark redesign brief | 0.919 | 0.660 | Run F012_BENCHMARK_REDESIGN_BRIEF before any further architecture search. |
| Architecture retry under old recall floor | 0.681 | 0.420 | Defer because F011 shows the recall floor is seed-specific and likely misleading. |
| Direct gate replacement | 0.773 | 0.600 | Reject in this cycle: locked gates cannot be changed silently to make results easier. |

## Monitor Decision
`COUNCIL_EXECUTE`

## Exact Next Amendment
Execute `F012 benchmark redesign brief`.

## Next Experiment Command Or Target
`Run F012_BENCHMARK_REDESIGN_BRIEF before any further architecture search.`
